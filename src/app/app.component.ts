...
export class AppComponent implements OnInit {
  constructor(
    ...
    const versionValue =
      ...
      (VERSION.hasOwnProperty("revision")
  ...
  ngOnInit() {
    ...
    this.restService.getUserLocationInfo().subscribe(
      userLocationInfo => {
        ...
        if (
          ...
          userLocationInfo.country == environment.restrictedCountryCode
        ) {
          this.dataService.userCountryRestricted = true;
        }
        console.log(
          "user country restricted:",
          this.dataService.userCountryRestricted
        );
      },
      error => {
